...
print('Welcome to the ContactBook. A program coded in python by Caleb Mealey.')
print('In this program, we will open the \'contacts.csv\' file and allow the user to create a record, retrieve a record, update a record, or delete a record.')
print('')
